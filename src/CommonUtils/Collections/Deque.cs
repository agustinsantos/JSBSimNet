...
namespace CommonUtils.Collections
{
    ...
    public sealed class Deque<T> : IList<T>, IReadOnlyList<T>, System.Collections.IList
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Deque&lt;T&gt;"/> class with the elements 
        ...
        public void Resize(int size, T value = default(T))
        {
            if (size < 0)
                throw new ArgumentOutOfRangeException(nameof(size), "Capacity may not be negative.");
