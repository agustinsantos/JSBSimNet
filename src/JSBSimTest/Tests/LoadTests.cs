...
namespace JSBSim.Tests
{
	...
	public class LoadTests
	{
        ...
        public void CheckLoad_Ball()
        {
            ...
            fdm.LoadModel("../../../Models/aircraft", "../../../Models/engine", aircraft_ball, true);
		...
		public void CheckLoad_737()
		{
			...
			fdm.LoadModel("../../../Models/aircraft", "../../../Models/engine", aircraft_737, true);
		...
		{
			FDMExecutive fdm = new FDMExecutive();
            fdm.LoadModel("../../../Models/aircraft", "../../../Models/engine", aircraft_747, true);
        ...
        {
            FDMExecutive fdm = new FDMExecutive();
            fdm.LoadModel("../../../Models/aircraft", "../../../Models/engine", aircraft_F16, true);
        ...
        {
            FDMExecutive fdm = new FDMExecutive();
            fdm.LoadModel("../../../Models/aircraft", "../../../Models/engine", aircraft_p51d, true);
        ...
        {
            FDMExecutive fdm = new FDMExecutive();
            fdm.LoadModel("../../../Models/aircraft", "../../../Models/engine", aircraft_A320, true);
        ...
        {
            FDMExecutive fdm = new FDMExecutive();
            fdm.LoadModel("../../../Models/aircraft", "../../../Models/engine", aircraft_c172x, true);
		...
		public void CheckLoad_MK82()
		{
			...
			fdm.LoadModel("../../../Models/aircraft", "../../../Models/engine", aircraft_MK82, true);
